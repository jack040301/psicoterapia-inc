            ...
            <div style="padding: 50px;" class="col-md-6">
                ...
                <div class="form-outline">
                    <form action="verify.php" method="post">
                        ...
                        <input style="margin-top:20px; font-size:9pt; padding:10px; width:100px;" name="moderator_verify" type="submit" value="Verify" class="btn btn-primary">
                    </form>
                </div>
                <p style="margin-top:10px; font-size:9pt;">Didn't recieve the code? <a href="verify.php?resends_otp=<?= $_SESSION['email']?>" style="color:#5065AF; text-decoration:none;">Resend Here</a></p>

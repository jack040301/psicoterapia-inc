            ...
            <section class="home-section">
                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                    <thead style="background-color:#F1F3FF; text-align:left;">
                        <tr><th>Ref. #</th><th>Time</th><th>Lastname</th><th>Firstname</th><th>Age</th><th>Contact No.</th><th>Physician</th><th>Status</th></tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                            <tr style="border-bottom:2px solid whitesmoke;"><td><?php echo $row['id']; ?></td><td><?php echo $row['time']; ?></td><td><?php echo ucwords($row['lastname']); ?></td><td><?php echo ucwords($row['firstname']); ?></td><td><?php echo number_format($row['userAge']); ?></td><td><?php echo $row['mobile']; ?></td><td>Doc. <?php echo ucwords($fetch_see_doctor['lastname']); ?></td><td><?php echo ucwords($row['status']); ?></td></tr>
                        <?php } ?>
                    </tbody>
                </table>

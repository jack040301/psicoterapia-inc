                    ...
                    <div class="col-md-8">
                        ...
                        <table style="width:80%; border-collapse:collapse; margin:auto; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <form action="profile.php" method="post">
                                    <td><input type="date" name="birthday" style="font-size:9pt;" max="<?php echo $lastYear = date("Y-m-d", strtotime("-21 years")); ?>" class="form-control" ondrop="return false;" onpaste="return false;" required="Required"></td>

        ...
        <div class="container-fluid row">
            <div class="sidebar">
                ...
                <ul class="nav-list">
                    ...
                    <li>
                        <a href="doctor.php"><i class='bx bxs-notepad' style="color:#000;"></i><span class="links_name">Doctors Schedule</span></a>
            ...
            <section class="home-section">
                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                    <thead style="background-color:#F1F3FF; text-align:left;">
                        <tr><th>ID</th><th>Lastname</th><th>Firstname</th><th>Time</th><th>Start Date</th><th>End Date</th><th>Action</th></tr>
                    </thead>
                    <tbody>
                        <?php
	                        ...
	                        $result_count = mysqli_query($connect,"SELECT COUNT(*) As total_records FROM tbl_employee WHERE position = 'doctor' AND status = 'online'");
                            ...
                            $get_data_query = "SELECT * FROM tbl_employee WHERE position = 'doctor' AND status = 'online' ORDER BY id ASC LIMIT $offset, $total_records_per_page";
                        ...
                        ?>
                            ...
                            <option disabled hidden selected><?php echo $row['time'];?></option>
                                <?php 
                                    ...
                                    $time = mysqli_query($connect, $time_query);
                                    if(mysqli_num_rows($time) > 0){
                                        for($i=0; $rows = mysqli_fetch_array($time); $i++){
                                ?>

                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                    ...
                    <tbody>
                        <?php
                            ...
                            $get_data_query = "SELECT *, DATEDIFF(date(now()), userBirthday)/365.25 as age FROM tbl_useraccount WHERE userStatus = 'verified' ORDER BY userID ASC LIMIT $offset, $total_records_per_page";

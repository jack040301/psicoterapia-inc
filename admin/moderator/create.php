    ...
    <body onload="display_ct();">
        ...
        <div class="container-fluid row">
            ...
            <div style="padding: 50px;" class="col-md-6">
                ...
                <h3 style="color:#5065AF">Doctors</h3>
                <div class="form-outline">
                    <form action="create.php" method="post">
                        ...
                        <input style="margin-top:20px; font-size:9pt; padding:10px; width:100px;" name="registers" type="submit" value="Register" class="btn btn-primary">
                    </form>
                </div>

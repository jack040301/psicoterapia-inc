...
<html>
    ...
    <head>
        ...
        <title><?php echo ucwords($fetch_company_details['companyname1']); ?><?php echo strtolower($fetch_company_details['companyname2']); ?> | Change Password</title>
        <meta charset="utf-8">
    ...
    <body onload="display_ct();">
        ...
        <div style="padding:0px; width:70%; margin-top:5%; margin-bottom:5%; margin-left:auto; margin-right:auto; border-radius:10px; box-shadow:rgba(99, 99, 99, 0.2)0px 2px 8px 0px;" class="container-fluid row">
            ...
            <div style="padding: 50px;" class="col-md-6">
                ...
                <h3 style="color:#5065AF">Change Password</h3>
                <div class="form-outline">
                    <form action="change.php" method="post">
                        <label style="margin-top:30px; font-size:9pt;" class="FormLabel form-label"><i class='bx bx-lock-alt'></i> New Password</label>
                        <input style="font-size:9pt; padding:10px;" name="npassword" type="password" ondrop="return false;" oninvalid="IninvalidMsg(this);" oninput="IninvalidMsg(this);" onpaste="return false;" class="form-control" placeholder="New Password" required="Required">
                        
                        <label style="margin-top:20px; font-size:9pt;" class="FormLabel form-label"><i class='bx bx-lock-alt'></i> Confirm New Password</label>
                        <input style="font-size:9pt; padding:10px;" name="cpassword" type="password" ondrop="return false;" oninvalid="IninvalidMsg(this);" oninput="IninvalidMsg(this);" onpaste="return false;" class="form-control" placeholder="Confirm new Password" required="Required">
                        
                        <input style="margin-top:20px; font-size:9pt; padding:10px; width:150px;" name="moderator_change" type="submit" value="Change Password" class="btn btn-primary">
                    </form>
                </div>

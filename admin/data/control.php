 ...
 */
 ...
 $expired_rate=1;
    ...
    $yesterday_appointment_querys = "SELECT COUNT(tbl_appts.status) as total_appointment FROM tbl_appts left join tbl_employee on tbl_appts.docID = tbl_employee.id WHERE date = date(now())-1 AND email = '$doc_email'";
    ...
    $yesterday_success_appointment_querys = "SELECT COUNT(tbl_appts.status) as total_success FROM tbl_appts left join tbl_employee on tbl_appts.docID = tbl_employee.id WHERE tbl_appts.status = 'done' AND date = date(now())-1 AND email = '$doc_email'";
    ...
    $yesterday_cancelled_appointment_querys = "SELECT COUNT(tbl_appts.status) as total_cancelled FROM tbl_appts left join tbl_employee on tbl_appts.docID = tbl_employee.id WHERE tbl_appts.status = 'cancelled' AND date = date(now())-1 AND email = '$doc_email'";
    ...
    $yesterday_expired_appointment_querys = "SELECT COUNT(tbl_appts.status) as total_expired FROM tbl_appts left join tbl_employee on tbl_appts.docID = tbl_employee.id WHERE tbl_appts.status = 'expired' AND date = date(now())-1 AND email = '$doc_email'";

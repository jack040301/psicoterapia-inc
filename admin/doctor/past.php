...
<html>
    ...
    <head>
        ...
        <title><?php echo ucwords($fetch_company_details['companyname1']); ?><?php echo strtolower($fetch_company_details['companyname2']); ?> | Past's Appointments</title>
        <meta charset="utf-8">
    ...
    <body onload="display_ct();">
        ...
        <div class="container-fluid row">
            ...
            <section class="home-section">
                ...
                <a href="past.php" style="text-decoration:none; font-size:10pt; padding:10px; background-color: rgba(203, 209, 231, .7); border-top: 2px solid #5065AF; text-shadow: 1px 1px 1px #fff;">Past's Appointments</a>
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                    ...
                    <tbody>
                        <?php
                            ...
                            $get_data_query = "SELECT *,t2.status FROM tbl_useraccount as t1 left join tbl_appts as t2 on t1.userID = t2.userID left join tbl_employee as t3 on t3.id = t2.docID WHERE date < date(now()) AND t3.email = '$email' ORDER BY id DESC LIMIT $offset, $total_records_per_page";

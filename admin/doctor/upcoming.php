            ...
            <section class="home-section">
                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="border-bottom:2px solid whitesmoke;"><td><?php echo $row['id']; ?></td><td><?php echo $row['date']; ?></td><td><?php echo $row['time']; ?></td><td><?php echo ucwords($row['userSurname']); ?></td><td><?php echo ucwords($row['userGivenName']); ?></td><td><?php echo number_format($row['userAge']); ?></td><td><?php echo $row['userContactNumber']; ?></td><td><?php echo ucwords($row['status']); ?></td></tr>
                        <?php } ?>
                    </tbody>
                </table>

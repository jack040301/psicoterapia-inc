...
<html>
    ...
    <body onload="display_ct();">
            ...
            <section class="home-section">
                ...
                <div class="card" style="width:18rem; margin:5px;">
                    <div class="card-body" style="text-align:center;">
                        ...
                        <span class="card-text" style="font-size:20pt;"><?php echo number_format($success_rates); ?>%</span><br>
                        <span class="card-text" style="font-size:9pt;">Overall Total: <?php echo $total_success_appointments ?></span>
                    </div>
                </div></div>
                ...
                <div class="card" style="width:18rem; margin:5px;">
                    <div class="card-body" style="text-align:center;">
                        ...
                        <span class="card-text" style="font-size:20pt;"><?php echo number_format($cancelled_rates); ?>%</span><br>
                        <span class="card-text" style="font-size:9pt;">Overall Total: <?php echo $total_cancelled_appointments ?></span>
                    </div>
                </div></div>
                <div class="col-sm" style="margin:auto;">
                <div class="card" style="width:18rem; margin:5px;">
                    <div class="card-body" style="text-align:center;">
                        ...
                        <span class="card-text" style="font-size:20pt;"><?php echo number_format($expired_rates); ?>%</span><br>
                        <span class="card-text" style="font-size:9pt;">Overall Total: <?php echo $total_expired_appointments ?></span>
                    </div>
                </div></div></div>
                <div class="container-fluid row">
                    <div class="col-lg" style="max-width:350px; padding:30px; margin:20px; border-radius:10px; box-shadow:rgba(99, 99, 99, 0.2)0px 2px 8px 0px;">
                        ...
                        <p style="font-size:10pt;"><i class='bx bx-calendar-check' style="font-size:14pt;"></i>  Total No. of Success: <?php echo $total_yesterday_success_appointments ?><br><i class='bx bx-calendar-x' style="font-size:14pt;"> </i> Total No. of Cancelled: <?php echo $total_yesterday_cancelled_appointments ?><br><i class='bx bxs-archive' style="font-size:14pt;"></i> Total No. of Expired: <?php echo $total_yesterday_expired_appointments ?><br><br><i class='bx bx-calendar-star' style="font-size:14pt;"></i> Overall Appointments: <?php echo $total_yesterday_appointments ?></p>
                    </div>
        ...
        <script>
        const labels = <?php echo json_encode($day_runs) ?>;
        const data = {
            labels: labels,
            datasets: [{

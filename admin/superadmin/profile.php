                    ...
                    <div class="col-md-8">
                        ...
                        <table style="width:80%; border-collapse:collapse; margin:auto; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input name="change_pic" type="submit" value="Upload Picture" style="background:none; border:none;color:#5065AF;"></td>
                                    </form>
                                </tr>
                                <tr>
                                    ...
                                    <td><input name="change_lastname" type="submit" value="Change" style="background:none; border:none;color:#5065AF;"></td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="profile.php" method="post">
                                    ...
                                    <td><input name="change_firstname" type="submit" value="Change" style="background:none; border:none;color:#5065AF;"></td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="profile.php" method="post">
                                    ...
                                    <td><input name="change_birthday" type="submit" value="Change" style="background:none; border:none;color:#5065AF;"></td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="profile.php" method="post">
                                    ...
                                    <td><input name="change_contact" type="submit" value="Change" style="background:none; border:none;color:#5065AF;"></td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="profile.php" method="post">
                                    ...
                                    <td><input name="change_email" type="submit" value="Change" style="background:none; border:none;color:#5065AF;" disabled hidden></td>
                                    </form>
                                </tr>
                            </tbody>
                        </table>
                        <table style="width:80%; border-collapse:collapse; margin:auto; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input name="change_p" type="submit" value="Change Password" style="font-size:9pt; float:right;" class="btn btn-primary"/></td>
                                </tr>
                                </form>
                            </tbody>
                        </table>

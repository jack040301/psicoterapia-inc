            ...
            <section class="home-section">
                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0; overflow: hidden;">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="border-bottom:2px solid whitesmoke;"><td><?php echo $row['id']; ?></td><td><?php echo $row['time']; ?></td><td><?php echo ucwords($row['lastname']); ?></td><td><?php echo ucwords($row['firstname']); ?></td><td><?php echo number_format($row['age']); ?></td><td><?php echo $row['mobile']; ?></td><td>Doc. <?php echo ucwords($fetch_see_doctor['lastname']); ?></td><td><?php echo ucwords($row['status']); ?></td></tr>
                        <?php } ?>
                    </tbody>
                </table>

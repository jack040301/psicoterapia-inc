...
<div class="whole">
  ...
  <div class="datepicker">
      ...
      <?php
          ...
          $records = mysqli_query($conn, "SELECT * FROM tbl_employee where position='doctor' and ( '$pick' between start_date AND end_date)");
          ...
          while($data = mysqli_fetch_array($records))
          {
            ...
            echo'<br><div class="card" style=" width:200px;
                    padding: 15px;">';
            ...
            echo'<a href="#"  data-bs-toggle="modal" data-bs-target="#exampleModal" class="modalButton btn btn-primary" data-docid="'.$data['id'].'" data-name="'. $data['lastname'] .'" data-time="'.$data['time'].'"  data-email="'. $data['email'] .'"">Schedule Appointment</a>';
            echo'</div></div>';
            echo'</div>';
          }
